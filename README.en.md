...
> **📌 Note:** This is the English version of the documentation, synchronized from the Chinese version ([README.md](./README.md)). The Chinese documentation is the authoritative primary reference. If you find any discrepancies, please refer to the Chinese version first.
...
- 🏷️ **Model Aliasing & Mapping** — Redirect client-requested model names to specific target model names (e.g. mapping `gpt-4o` to `deepseek-chat`)
